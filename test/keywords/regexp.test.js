...
describe("Koncorde.keyword.regexp", () => {
  ...
  describe("#validation", () => {
    it("should reject empty filters", () => {
      should(() => koncorde.validate({ regexp: {} })).throw({
        keyword: "regexp",
    ...
    it("should reject filters with more than 1 field", () => {
      ...
      should(() => koncorde.validate({ regexp: filter })).throw({
        keyword: "regexp",
    ...
    it("should reject filters with an empty field object", () => {
      should(() => koncorde.validate({ regexp: { foo: {} } })).throw({
        keyword: "regexp",
    ...
    it("should reject filters with other fields defined other than the accepted ones", () => {
      ...
      should(() => koncorde.validate({ regexp: filter })).throw({
        keyword: "regexp",
        message:
          '"regexp.foo": "bar" is not an allowed attribute (allowed: flags,value)',
        path: "regexp.foo",
      });
    });
    ...
    it('should reject filters if the "value" attribute is not defined', () => {
      should(() =>
        koncorde.validate({ regexp: { foo: { flags: "ig" } } }),
      ).throw({
        keyword: "regexp",
    ...
    it('should reject filters with a non-string "flags" attribute', () => {
      should(() =>
        koncorde.validate({ regexp: { foo: { value: "foo", flags: 42 } } }),
      ).throw({
        keyword: "regexp",
    ...
    it("should reject filters with an invalid regular expression value", () => {
      should(() =>
        koncorde.validate({ regexp: { foo: { value: "foo(", flags: "i" } } }),
      ).throw({
        keyword: "regexp",
  ...
  describe("#matching", () => {
    ...
    it("should not match a document if its registered field does not match the regexp", () => {
      ...
      should(koncorde.test({ foo: "Saskatchewan" }))
        .be.an.Array()
        .and.be.empty();
    });
