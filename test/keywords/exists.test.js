...
describe("Koncorde.keyword.exists", () => {
  ...
  describe("#validation", () => {
    it("should reject empty filters", () => {
      should(() => koncorde.validate({ exists: {} })).throw({
        keyword: "exists",
    ...
    it("should reject filters with more than 1 field", () => {
      should(() =>
        koncorde.validate({ exists: { field: "foo", bar: "bar" } }),
      ).throw({
        keyword: "exists",
    ...
    it('should reject filters in object-form without a "field" attribute', () => {
      should(() => koncorde.validate({ exists: { foo: "bar" } })).throw({
        keyword: "exists",
    ...
    it("should reject filters with array argument", () => {
      should(() => koncorde.validate({ exists: { field: ["bar"] } })).throw({
        keyword: "exists",
    ...
    it("should reject filters with number argument", () => {
      should(() => koncorde.validate({ exists: { field: 42 } })).throw({
        keyword: "exists",
        message: '"exists.field": must be a string',
        path: "exists.field",
      });
    ...
    it("should reject filters with object argument", () => {
      should(() => koncorde.validate({ exists: { field: {} } })).throw({
        keyword: "exists",
        message: '"exists.field": must be a string',
        path: "exists.field",
      });
    ...
    it("should reject filters with undefined argument", () => {
      should(() => koncorde.validate({ exists: { field: undefined } })).throw({
        keyword: "exists",
        message: '"exists": the property "field" is missing',
        path: "exists",
      });
    ...
    it("should reject filters with null argument", () => {
      should(() => koncorde.validate({ exists: { field: null } })).throw({
        keyword: "exists",
        message: '"exists.field": must be a string',
        path: "exists.field",
      });
    ...
    it("should reject filters with boolean argument", () => {
      should(() => koncorde.validate({ exists: { field: true } })).throw({
        keyword: "exists",
        message: '"exists.field": must be a string',
        path: "exists.field",
      });
    ...
    it("should validate filters with a string argument", () => {
      should(() => koncorde.validate({ exists: { field: "bar" } })).not.throw();
    });
  ...
  describe("#standardization", () => {
    it("should return the normalized filter (from old syntax)", () => {
      ...
      should(result).match({
        exists: new NormalizedExists("bar", false, null),
      });
    });
  ...
  describe("#storage", () => {
    ...
    it("should store multiple subfilters on the same condition correctly", () => {
      ...
      should(storage.fields.get("foo").subfilters).eql(
        new Set([barSubfilter, quxSubfilter]),
      );
    ...
    it("should store a single array search correctly", () => {
      ...
      should(storage.fields.get("foo").values.get("bar")).eql(
        new Set([subfilter]),
      );
    });
    ...
    it("should multiple array searches correctly", () => {
      ...
      const id2 = koncorde.register({
        and: [{ exists: 'qux["bar"]' }, { exists: 'foo["bar"]' }],
      });
      ...
      should(storage.fields.get("qux").values.get("bar")).eql(
        new Set([quxSubfilter]),
      );
    });
  });
  ...
  describe("#matching", () => {
    ...
    it("should match if a searched value is in the document", () => {
      ...
      for (let i = 0; i < ids.length; i++) {
        ...
        should(koncorde.test({ foo: ["hello", expected, "world"] })).eql([
          ids[i],
        ]);
      }
    });
  ...
  describe("#removal", () => {
    ...
    it("should remove a single subfilter from a multi-filter condition", () => {
      const id1 = koncorde.register({ exists: "foo" });
      const id2 = koncorde.register({
        and: [{ equals: { foo: "qux" } }, { exists: { field: "foo" } }],
      });
      ...
      should(storage.fields.get("foo").subfilters).match(
        new Set([multiSubfilter]),
      );
    ...
    it("should remove a single subfilter from a multi-filter array condition", () => {
      const id1 = koncorde.register({ exists: 'foo["bar"]' });
      const id2 = koncorde.register({
        and: [{ equals: { foo: "qux" } }, { exists: { field: 'foo["bar"]' } }],
      });

      const storage = engine.foPairs.get("exists");
      const singleSubfilter = Array.from(engine.filters.get(id1).subfilters)[0];
      const multiSubfilter = Array.from(engine.filters.get(id2).subfilters)[0];
      should(storage.fields.get("foo").values.get("bar")).match(
        new Set([singleSubfilter, multiSubfilter]),
      );
