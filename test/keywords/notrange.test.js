...
describe("Koncorde.keyword.notrange", () => {
  ...
  describe("#storage", () => {
    it("should store a single condition correctly", () => {
      ...
      const rangeCondition = Array.from(
    ...
    it("should store multiple conditions on the same field correctly", () => {
      ...
      const cd3 = store.fields
        .get("foo")
        .conditions.get(Array.from(sf2.conditions)[1].id);
  ...
  describe("#removal", () => {
    ...
    it("should remove a single subfilter from a multi-filter condition", () => {
      ...
      const rcd = storage.fields
        .get("foo")
        .conditions.get(Array.from(multiSubfilter.conditions)[0].id);
